...
class Ui_QUICreator(object):
    def setupUi(self, QUICreator):
        ...
        self.gridLayout_6.addWidget(self.doc_path, 16, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.doc_heading, 2, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.doc_type, 5, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.doc_company, 3, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.doc_code, 4, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.doc_content4, 13, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.doc_reporter, 6, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.doc_date, 7, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.doc_content1, 10, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.doc_content3, 12, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.doc_content2, 11, 2, 1, 1)
        ...
        self.doc_source = QtWidgets.QPushButton(self.groupBox_2)
        ...
        self.gridLayout_6.addWidget(self.doc_source, 17, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.doc_filename, 15, 2, 1, 1)
        ...
        self.doc_3_text1 = QtWidgets.QPlainTextEdit(self.text3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.doc_3_text1.sizePolicy().hasHeightForWidth())
        self.doc_3_text1.setSizePolicy(sizePolicy)
        self.doc_3_text1.setObjectName("doc_3_text1")
        self.gridLayout_7.addWidget(self.doc_3_text1, 4, 1, 1, 1)
        ...
        self.doc_3_button3 = QtWidgets.QPushButton(self.text3)
        self.doc_3_button3.setObjectName("doc_3_button3")
        self.gridLayout_7.addWidget(self.doc_3_button3, 3, 0, 1, 1)
        self.doc_3_picname3 = QtWidgets.QLineEdit(self.text3)
        self.doc_3_picname3.setReadOnly(False)
        self.doc_3_picname3.setClearButtonEnabled(True)
        self.doc_3_picname3.setObjectName("doc_3_picname3")
        self.gridLayout_7.addWidget(self.doc_3_picname3, 3, 1, 1, 1)
        ...
        self.doc_3_pic = QtWidgets.QLabel(self.text3)
        self.doc_3_pic.setText("")
        self.doc_3_pic.setObjectName("doc_3_pic")
        self.gridLayout_7.addWidget(self.doc_3_pic, 0, 1, 1, 1)
...
"却总在瞬间崩溃。"))
        ...
        self.doc_2_start.setText(_translate("QUICreator", "请输入id"))
        self.label_23.setText(_translate("QUICreator", "to"))
        self.doc_2_end.setText(_translate("QUICreator", "请输入id"))
        ...
        self.doc_3_button3.setText(_translate("QUICreator", "选择图片"))
        self.doc_3_picname3.setText(_translate("QUICreator", "图片命名"))
