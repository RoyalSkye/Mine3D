...
if _glfw_file is None:
    order = ['glfw', 'glfw3']
    for check in order:
        _glfw_file = ctypes.util.find_library('/Users/skye/PycharmProjects/20190302/Visualization/glfw3.dll')
        print(_glfw_file)
...
# Load it
# _glfw_file = '../dylib/libglfw.3.2.dylib'
_glfw = ctypes.CDLL(_glfw_file)
# _glfw = ctypes.cdll.LoadLibrary('../dylib/libglfw.3.2.dylib')
